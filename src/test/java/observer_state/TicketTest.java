...
public class TicketTest {
    ...
    public void setUp() {
        ...
        ticket = new Ticket("Ticket A", solicitante);
    }
    ...
    public void naoDeveAbrirTicketAberto() {
        ...
        assertEquals("João, atualização no Ticket{nome='Ticket A', estado='Aberto'}", solicitante.getUltimaNotificacao());
    }
    ...
    public void deveCancelarTicketAberto() {
        ...
        assertEquals("João, atualização no Ticket{nome='Ticket A', estado='Cancelado'}", solicitante.getUltimaNotificacao());
    ...
    public void deveTramitarTicketAberto() {
        ...
        assertEquals("João, atualização no Ticket{nome='Ticket A', estado='Em andamento'}", solicitante.getUltimaNotificacao());
    }
    ...
    public void deveResolverTicketEmAndamento() {
        ...
        assertEquals("João, atualização no Ticket{nome='Ticket A', estado='Resolvido'}", solicitante.getUltimaNotificacao());
    }
    ...
    public void deveFecharTicketResolvido() {
        ...
        assertEquals("João, atualização no Ticket{nome='Ticket A', estado='Fechado'}", solicitante.getUltimaNotificacao());
    }
    ...
    void naoDeveNotificarSolicitante() {
        ...
        Ticket ticketB = new Ticket("Ticket B", solicitante1);
    ...
    void deveNotificarSolicitanteTicketB() {
        ...
        Pessoa solicitante2 = new Pessoa("Carlos");
        Ticket ticketB = new Ticket("Ticket B", solicitante1);
        Ticket ticketC = new Ticket("Ticket C", solicitante2);
        assertTrue(ticketB.tramitar());
        assertEquals(TicketEstadoEmAndamento.getInstance(), ticketB.getEstado());
        assertEquals("Arnaldo, atualização no Ticket{nome='Ticket B', estado='Em andamento'}", solicitante1.getUltimaNotificacao());
        assertEquals(null, solicitante2.getUltimaNotificacao());
    }
}
